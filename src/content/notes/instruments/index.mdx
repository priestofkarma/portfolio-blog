...
-  [GitLens — Git supercharged](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens)
    ...
    Расширяет возможности, изуализирует авторство кода с помощью аннотаций  прямо в коде, и многое другое
...
- FTP клиент - [WinSCP](https://winscp.net/eng/docs/lang:ru) для Windows и [Transmit](https://panic.com/transmit/) для Mac
- [Notion](https://www.notion.so/) для заметок
